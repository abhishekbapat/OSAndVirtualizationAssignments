...
hypervisor_entry_t hyperv_signature_xen;
...
uint32_t xen_detect()
{
	...
	hyperv_signature_xen.ebx = 0x566e6558;
	hyperv_signature_xen.ecx = 0x65584d4d;
	hyperv_signature_xen.edx = 0x4d4d566e;
	hyperv_signature_xen.min_leaves = 2;
